...
public class Utils {
    ...
    public static User getUser(Player player) {
        return VillageDefenseMoreContents.getInstance().getParentPlugin().getUserManager().getUser(player);
    }
    ...
    public static boolean checkDisplayName(ItemStack itemStack, Messages message) {
        return checkDisplayName(itemStack, VillageDefenseMoreContents.getInstance().getParentPlugin().getChatManager().colorMessage(message));
    }
}
